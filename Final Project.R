unzip("C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/getdata%2Fprojectfiles%2FUCI HAR Dataset.zip")

data_x_test <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/test/X_test.txt",
                       stringsAsFactors = FALSE)
data_y_test <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/test/y_test.txt",
                          stringsAsFactors = FALSE)
data_subj_test <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/test/subject_test.txt",
                          stringsAsFactors = FALSE)
data_x_train <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/train/X_train.txt",
                          stringsAsFactors = FALSE)
data_y_train <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/train/y_train.txt",
                          stringsAsFactors = FALSE)
data_subj_train <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/train/subject_train.txt",
                             stringsAsFactors = FALSE)
...
feat_tbl <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/features.txt",
                       stringsAsFactors = FALSE)
...
labels <- read.table(file = "C:/Users/mmads/Desktop/Getting and Cleaning Data/Final Project/UCI HAR Dataset/activity_labels.txt",
                     stringsAsFactors = FALSE)
